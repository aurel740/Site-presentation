...
const Accueil = () => {
    ...
    return (
        <section id='Accueil'>
            ...
            <p itemprop="description">Diplômé de la formation <strong>OpenClassrooms</strong> en développement web, je suis motivé et disponible pour mettre mes compétences 
